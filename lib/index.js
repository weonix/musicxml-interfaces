...
function noteToXML(note) {
    ...
    if (note.ties && note.ties.length) {
        note.ties.forEach(function (tie) {
            var tieAttribs = xml(templateObject_245 || (templateObject_245 = __makeTemplateObject([" type=\"", "\""], [" type=\"", "\""])), tie.type === StartStop.Stop ? "stop" : "start");
